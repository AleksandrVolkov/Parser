 ...
 */
public class JavaShashki extends JPanel {
...
//        JFrame window1 = new JFrame("Checkers1");
//        Checker
//        JavaShashki j = new JavaShashki();
        JavaShashki content = new JavaShashki();
